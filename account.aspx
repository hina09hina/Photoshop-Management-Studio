   ...
   <div class="hero_area">
    ...
    <div class="container">
      ...
      <div class="portfolio_container ">
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" Width="318px" Height="163px" 
                         AutoGenerateRows="False" DataKeyNames="userid" DataSourceID="SqlDataSource1" CssClass=" borer-light">
            <Fields>
                ...
                <asp:CommandField ShowEditButton="True" />
                     ...
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                         ...
                         SelectCommand="SELECT * FROM [userss] WHERE ([userid] = @userid)" 
                 ...
                 <div class="heading_container heading_center">      
                  <h2>
                   ...
                   <a href="bill.aspx"> Download Your Booking Reciept</a>
                   </h2>

                   </div>
      <div align=center>
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
              DataKeyNames="billid" DataSourceID="SqlDataSource2">
          <Columns>
